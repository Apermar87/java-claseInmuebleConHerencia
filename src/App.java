...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        cr1.calcularValorCompra(cr1.valorArea);
        cr1.imprimir();
        ...
        cc1.calcularValorCompra(cc1.valorArea);
        cc1.imprimir();
